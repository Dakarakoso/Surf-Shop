...
module.exports = {
 ...
 async postLogin(req, res, next) {
  ...
  async putForgotPw(req, res, next) {
    ...
    const msg = {
      to: email,
      from: 'Surf Shop Admin <willianmaruyamapv@gmail.com>',
      ...
      Please click on the following link, or copy and paste it into your browser
      to complete the process: http://${req.headers.host}/reset/${token}
